...
const About = () => {
  return (
    ...
    <div className=" flex flex-col bg-[rgb(36,36,36)] relative  md:px-8  md:py-28  mx-auto text-white  md:text-left md:flex-row  h-screen justify-evenly content-center">
      <div className="bg-white-500 relative w-[400px] h-[350px] ">
        <Image className="flex-shrink-0 object-cover w-[300px] max-sm:mx-auto  h-[300px] md:w-[350px] md:h-[500px] rounded-full md:rounded absolute top-6  left-6    " src="/My project-1 (7).jpg" alt="gdfdfg" width={300} height={500} />
      ...
      <div className="    text-center max-sm:w-auto w-[60vh] md:pt-14 ">
        ...
        <p className=" text-left max-auto  max-sm:mx-auto  indent-8 md:text-center max-md:text-[15px] md:pt-2   leading-6 md:text-gray-100 md:text-[15px]  ">
